...
const getButtonMainParentCollect=getTargetButton.parentNode.parentNode.parentNode
const company_name_now=getButtonMainParentCollect.querySelector('.company-name').innerText
const job_position_now=getButtonMainParentCollect.querySelector('.job-position').innerText
...
const test_now = rejectedSectionCollect.children;
      ...
      const findElement = newData.findIndex((f) => {
        ...
        return companyName === company_name_now && jobPoisiton === job_position_now;
      });
